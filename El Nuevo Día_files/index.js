...
/* harmony export */ });
/* harmony import */ var core_js_modules_es6_regexp_match_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
/* harmony import */ var core_js_modules_es6_string_includes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(38);
...
/* harmony import */ var core_js_modules_es7_array_includes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(42);
...
var AirshipConfig = /*#__PURE__*/function () {
  function AirshipConfig(conf) {
    this.conf = conf;
    this.INVALID_WP_ROUTES = ["/pf/preview/", "/login/", "/pf/admin/", "/pf/api/", "/pagebuilder/editor"];
  }

  var _proto = AirshipConfig.prototype;

  _proto.uaScript = function uaScript() {
    var _this = this;

    window.UA = {
      _async_setup: function _async_setup(func) {
        window.UA = func({
          vapidPublicKey: _this.conf.vapidPublicKey,
          websitePushId: _this.conf.websitePushId,
          appKey: _this.conf.appKey,
          workerUrl: _this.conf.workerUrl,
          token: _this.conf.token
        });

        _this.registerUserForWebPush();
      }
    };
    var script = document.createElement("script");
    script.src = "https://aswpsdkus.com/notify/v1/ua-sdk.min.js";
  ...
  _proto.load = function load() {
    ...
    window.addEventListener("load", function () {
      ...
      window.addEventListener("scroll", function () {
        if (added) return;
        document.body.appendChild(_this2.uaScript());
  ...
  _proto.shouldRegister = function shouldRegister(sdk) {
    var activePath = window.location.pathname || "";
    var invalidRoute = "";
    var x = 0;

    for (; x < this.INVALID_WP_ROUTES.length; x += 1) {
      invalidRoute = this.INVALID_WP_ROUTES[x];
  ...
  _proto.setVerificationForRegisteredDevice = function setVerificationForRegisteredDevice() {
    this.setCookie("askForWbpnRegistration", "no", 365);
  };

  _proto.registerUserForWebPush = function registerUserForWebPush() {
    var _this3 = this;

    if (window.Notification && Notification.permission === "granted") {
      // eslint-disable-next-line no-undef
      UA.then(function (sdk) {
        if (_this3.shouldRegister(sdk)) {
          sdk.register();

          _this3.setVerificationForRegisteredDevice();
        }
      });
    }

    var askForWbpnRegistration = this.getCookie("askForWbpnRegistration");

    if (askForWbpnRegistration === "" || askForWbpnRegistration == null) {
      askForWbpnRegistration = "yes";
    }

    if (askForWbpnRegistration === "yes") {
      // eslint-disable-next-line no-undef
      UA.then(function (sdk) {
        ...
        if (popupModal) {
          if (_this3.shouldRegister(sdk)) {
            ...
            noBtn.onclick = function () {
              ...
              _this3.setCookie("askForWbpnRegistration", "no", 30);
            };
          }

          sdk.addEventListener("channel", function (e) {
            console.log(e.channel); // eslint-disable-line no-console
          });
        }
      })["catch"](function (b) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AirshipConfig);
...
var advanceStringIndex = __webpack_require__(8);
var regExpExec = __webpack_require__(11);

// @@match logic
__webpack_require__(20)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
var regexpFlags = __webpack_require__(23);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _el_nuevo_dia_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53);
...
/* harmony import */ var _shared_js_airship_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);


new _shared_js_airship_config__WEBPACK_IMPORTED_MODULE_1__.default(window.GFRWebPushConfig).load();
})();
